...
namespace XLua
{
    public partial class ObjectTranslator
    {
        ...
        class IniterAdderCClientRoleData
        {
            static IniterAdderCClientRoleData()
            {
			...
			static void Init(LuaEnv luaenv, ObjectTranslator translator)
			{
				...
				translator.RegisterPushAndGetAndUpdate<CClientRoleData>(translator.PushCClientRoleData, translator.Get, translator.UpdateCClientRoleData);
				...
				translator.RegisterCaster<TestProto>(translator.Get);
				translator.RegisterCaster<MapObjectData>(translator.Get);
			}
        }
        
        static IniterAdderCClientRoleData s_IniterAdderCClientRoleData_dumb_obj = new IniterAdderCClientRoleData();
        static IniterAdderCClientRoleData IniterAdderCClientRoleData_dumb_obj {get{return s_IniterAdderCClientRoleData_dumb_obj;}}
        
        
        int CClientRoleData_TypeID = -1;
        public void PushCClientRoleData(RealStatePtr L, CClientRoleData val)
        {
            if (CClientRoleData_TypeID == -1)
            {
			    bool is_first;
                CClientRoleData_TypeID = getTypeId(L, typeof(CClientRoleData), out is_first);
				
            }
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 24, CClientRoleData_TypeID);
            if (!CopyByValue.Pack(buff, 0, val))
            {
                throw new Exception("pack fail fail for CClientRoleData ,value="+val);
            }
			
        }
		
        public void Get(RealStatePtr L, int index, out CClientRoleData val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != CClientRoleData_TypeID)
				{
				    throw new Exception("invalid userdata for CClientRoleData");
				}
				
                IntPtr buff = LuaAPI.lua_touserdata(L, index);if (!CopyByValue.UnPack(buff, 0, out val))
                {
                    throw new Exception("unpack fail for CClientRoleData");
                }
            }
            ...
            {
                val = (CClientRoleData)objectCasters.GetCaster(typeof(CClientRoleData))(L, index, null);
            }
        }
		
        public void UpdateCClientRoleData(RealStatePtr L, int index, CClientRoleData val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  val))
                {
                    throw new Exception("pack fail for CClientRoleData ,value="+val);
                }
            }
		...
		public void Get(RealStatePtr L, int index, out TestProto val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    val = (TestProto)FastGetCSObj(L, index);
            }
			else if (type == LuaTypes.LUA_TTABLE)
			{
			    val = new TestProto();
				...
				if (Utils.LoadField(L, index, "price"))
				{
					Get(L, top + 1, out val.price);
				}
				LuaAPI.lua_pop(L, 1);
            ...
            {
                throw new Exception("can not cast " + LuaAPI.lua_type(L, index) + " to " + typeof(TestProto));
            }
        }
		
		public void Get(RealStatePtr L, int index, out MapObjectData val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    val = (MapObjectData)FastGetCSObj(L, index);
            }
			else if (type == LuaTypes.LUA_TTABLE)
			{
			    val = new MapObjectData();
				int top = LuaAPI.lua_gettop(L);
				
				if (Utils.LoadField(L, index, "RefID"))
				{
					Get(L, top + 1, out val.RefID);
				}
				LuaAPI.lua_pop(L, 1);
				...
				if (Utils.LoadField(L, index, "SN"))
				{
					Get(L, top + 1, out val.SN);
				}
				LuaAPI.lua_pop(L, 1);
				
				if (Utils.LoadField(L, index, "Dir_X"))
				{
					Get(L, top + 1, out val.Dir_X);
				}
				LuaAPI.lua_pop(L, 1);
				
				if (Utils.LoadField(L, index, "Dir_Z"))
				{
					Get(L, top + 1, out val.Dir_Z);
				}
				LuaAPI.lua_pop(L, 1);
				
				if (Utils.LoadField(L, index, "LeftTime"))
				{
					Get(L, top + 1, out val.LeftTime);
				}
				LuaAPI.lua_pop(L, 1);
				
				if (Utils.LoadField(L, index, "MasterId"))
				{
					Get(L, top + 1, out val.MasterId);
				}
				LuaAPI.lua_pop(L, 1);
				
				if (Utils.LoadField(L, index, "Owner_Name"))
				{
					Get(L, top + 1, out val.Owner_Name);
				}
				LuaAPI.lua_pop(L, 1);
				
				if (Utils.LoadField(L, index, "OpenTimes"))
				{
					Get(L, top + 1, out val.OpenTimes);
				}
				LuaAPI.lua_pop(L, 1);
            ...
            {
                throw new Exception("can not cast " + LuaAPI.lua_type(L, index) + " to " + typeof(MapObjectData));
            }
        }
	...
	public partial class StaticLuaCallbacks
    {
	    internal static bool __tryArrayGet(Type type, RealStatePtr L, ObjectTranslator translator, object obj, int index)
		{
			...
			if (type == typeof(CClientRoleData[]))
			{
			    CClientRoleData[] array = obj as CClientRoleData[];
				translator.PushCClientRoleData(L, array[index]);
				return true;
			}
		...
		internal static bool __tryArraySet(Type type, RealStatePtr L, ObjectTranslator translator, object obj, int array_idx, int obj_idx)
		{
			...
			else if (type == typeof(TestProto[]))
			{
			    TestProto[] array = obj as TestProto[];
				translator.Get(L, obj_idx, out array[array_idx]);
				return true;
			}
			else if (type == typeof(MapObjectData[]))
			{
			    MapObjectData[] array = obj as MapObjectData[];
				translator.Get(L, obj_idx, out array[array_idx]);
				return true;
			}
            return false;
