...
public class DownloadMgr : Singleton<DownloadMgr>
{
    ...
    public void InitStreamingAssets(Action onInitComplete)
    {
        ...
        else
        {
            ...
            //
            NetWorkSocket.Instance.StartCoroutine(ReadStreamingAssetVersionFile(versionFileUrl, OnReadStreamingAssetOver));
        }
    }
    ...
    {
        NetWorkSocket.Instance.StartCoroutine(InitStreamingAssetList(content));
    }
    ...
    private IEnumerator InitStreamingAssetList(string content)
    {
        ...
        for (int i = 0; i < arr.Length; i++)
        {
            ...
            yield return NetWorkSocket.Instance.StartCoroutine(AssetLoadToLocal(m_StreamingAssetsPath + fileUrl, LocalFilePath + fileUrl));
        ...
        //解压版本文件
        yield return NetWorkSocket.Instance.StartCoroutine(AssetLoadToLocal(m_StreamingAssetsPath + m_VersionFileName, LocalFilePath + m_VersionFileName));
