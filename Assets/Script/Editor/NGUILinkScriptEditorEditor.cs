...
[CustomEditor(typeof(NGUILinkScriptEditor))]
public class NGUILinkScriptEditorEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        NGUILinkScriptEditor link = target as NGUILinkScriptEditor;
        SetUIDebug(link);
        GUI.changed = false;
        if (link.Links != null)
        {
            ...
            {
                NGUILinkScriptEditor.UILink uilink = link.Links[i];
    ...
    private static void SetUIDebug(NGUILinkScriptEditor link)
    {
        CClientCommon.AddComponent<DebugUILine>(link.gameObject);
        //CClientCommon.AddComponent<NGUILink>(link.gameObject);
    }
