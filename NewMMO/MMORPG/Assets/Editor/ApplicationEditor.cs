...
//    }
    ...
    public static void OpenAndRunLoginScene()
    {
        ...
        int index = GetSceneIndex("Scene_Init");

        if (EditorApplication.currentScene == "Scene_Init")
        {
            return;
        }
        ...
        if (GameObject.Find("Scene_Init") != null)
        {
            GameObject.Find("Scene_Init").gameObject.SetActive(true); ;
            //GameObject.Find("Scene_Init").gameObject.GetComponent<Launcher>().enabled = true;
        }
